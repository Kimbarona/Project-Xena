            ...
            <form action="/save-remarks" method="POST">
                ...
                <div class="form-group">
                    ...
                    <select name="remarks" class="form-control" required>
                        <option value=""></option>
                        <option value="Unprocess-date">Unprocess-date</option>
                        <option value="Loading">Loading</option>
                        <option value="Manual">Manual</option>
                        <option value="Regenerate">Regenerate</option>
                        <option value="Un-Zreading">Un-Zreading</option>
...
<table id="TableReports" class="table">
    <thead class=" text-primary">
        ...
        <th width="20%"><font color='grey'size='4px' >Store Name</font></th>
                            ...
                            // $countMissingUpd = $entries[$ctr][$d]['CountMissingUpd'];
                                ...
                                if($status == 'available'){
                                    ...
                                    ?>
                                        ...
                                        <input type="text" style="background-color:Black; height:0px; color:rgb(0, 0, 0);border:0px " class="form-control"  readonly onclick="myFunction(this.value,<?php echo $entries[$ctr][$d]['storecode'];?>,<?php echo $entries[$ctr][$d]['id'];?>)" value="<?php echo $regdates[$i];?>">
